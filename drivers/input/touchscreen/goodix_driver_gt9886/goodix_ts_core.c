...
static ssize_t goodix_ts_tolerance_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	struct goodix_ts_core *core_data = dev_get_drvdata(dev);
...
static ssize_t goodix_ts_tolerance_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int rc, i;
	unsigned int u[Touch_Mode_NUM] = { 0 };
...
static ssize_t goodix_ts_up_threshold_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	struct goodix_ts_core *core_data = dev_get_drvdata(dev);
...
static ssize_t goodix_ts_up_threshold_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int rc, i;
	unsigned int u[Touch_Mode_NUM] = { 0 };
...
static ssize_t goodix_ts_edge_filter_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	struct goodix_ts_core *core_data = dev_get_drvdata(dev);
...
static ssize_t goodix_ts_edge_filter_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int rc, i;
	unsigned int u[Touch_Mode_NUM] = { 0 };
...
static DEVICE_ATTR(tolerance, 0664,
		goodix_ts_tolerance_show, goodix_ts_tolerance_store);
static DEVICE_ATTR(up_threshold, 0664,
		goodix_ts_up_threshold_show, goodix_ts_up_threshold_store);
static DEVICE_ATTR(edge_filter, 0664,
		goodix_ts_edge_filter_show, goodix_ts_edge_filter_store);
#endif
